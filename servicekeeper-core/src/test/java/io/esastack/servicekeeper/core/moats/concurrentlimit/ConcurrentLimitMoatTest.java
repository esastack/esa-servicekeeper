...
class ConcurrentLimitMoatTest {
    ...
    void testUpdateMaxConcurrentLimit0() throws InterruptedException {
        ...
        BDDAssertions.then(limitMoat2.getConcurrentLimiter().immutableConfig()).isNull();
        BDDAssertions.then(limitMoat2.getConcurrentLimiter().metrics().threshold()).isEqualTo(newestMaxConcurrentLimit);
    }
    ...
    void testUpdateMaxConcurrentLimit1() {
        ...
        BDDAssertions.then(limitMoat0.getConcurrentLimiter().metrics().threshold()).isEqualTo(maxConcurrentLimit);
        ...
        BDDAssertions.then(limitMoat1.getConcurrentLimiter().metrics().threshold()).isEqualTo(maxConcurrentLimit);
        ...
        BDDAssertions.then(limitMoat3.getConcurrentLimiter().metrics().threshold()).isEqualTo(this.maxConcurrentLimit);
    }
